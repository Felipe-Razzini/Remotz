...
tasks = [
  ...
  task = { title: "Bootstrap sprint", priority: "High", status: "In progress", start:"#{Date.today}", end:"#{Date.today}",user_id:felipe.id},
  ...
  task_7 = { title: "Meeting with Francesca", priority: "Low", status: "Delayed", start:"7-12-2023", end:"7-12-2023",user_id:felipe.id},
